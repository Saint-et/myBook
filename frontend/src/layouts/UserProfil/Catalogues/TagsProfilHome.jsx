...
const TagsProfilHome = (props) => {
    ...
    return (
        <>
            ...
            {open && <div className='blanket animation' style={{ zIndex: 15000, display: 'flex', alignItems: 'center', flexDirection: 'column', justifyContent: 'center', top: 0 }} >
                <RemoveScroll className='menu_navbar scrollbar open-elementPage' style={{ width: '100%', flexDirection: 'column', maxWidth: 1200, overflowY: 'auto', alignItems: 'center', background: 'none' }} data-theme={localTheme}>
            ...
            <div className='cter_sect'>
                <div style={{ width: '95%', display: 'flex', alignItems: 'center' }}>
                    <h3 className='text' data-background={localThemeBackground} data-theme={localTheme}>Tags</h3>
                    {IdUser === props.promiseApp.user.id && <div onClick={() => { setOpen(true) }} className='buttonCircle' style={{ width: 20, height: 20, display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: 12, marginBottom: -5 }} data-theme={localTheme}>
