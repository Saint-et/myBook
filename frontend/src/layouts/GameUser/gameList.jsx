        ...
        <div className='main'>
            <div className='cter_sect'>
                <div className='ctent_arti' style={{ maxWidth: 500, marginBottom: 50, padding: 0 }} data-theme={localTheme}>
                    <h1 className='textLoto' style={{ fontSize: 40, textAlign: 'center' }}>{SystemName} Game List</h1>
                </div>
            </div>

            <div className='cter_sect'>
                <div className='ctent_arti' style={{ background: 'none' }} data-theme={localTheme}>
                    <Link to={`/${SystemName}-game/werewolf-attack`} className='card_user_presentation hovercursor' data-theme={localTheme}>
