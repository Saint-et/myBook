...
import background from '../../../../assets/gameComponents/backgrounds/8-bit-graphics-pixels-scene-with-house-trees2.jpg';
import wereWolf from '../../../../assets/gameComponents/characters/Black_Werewolf/Idle.png';
import wereWolfRun from '../../../../assets/gameComponents/characters/Black_Werewolf/Run.png';
import wereWolfAttack1 from '../../../../assets/gameComponents/characters/Black_Werewolf/Attack_1.png';
import wereWolfJump from '../../../../assets/gameComponents/characters/Black_Werewolf/Jump.png';
...
export default class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('character', wereWolf, { frameWidth: 128, frameHeight: 128 });
        this.load.spritesheet('characterRun', wereWolfRun, { frameWidth: 128, frameHeight: 128 });
        this.load.spritesheet('characterAttack1', wereWolfAttack1, { frameWidth: 128, frameHeight: 128 });
        this.load.spritesheet('characterJump', wereWolfJump, { frameWidth: 128, frameHeight: 128 });
    }
    ...
    create() {
        ...
        const playButtonLeave = this.add.text(windowWidth * 0.95, windowHeight * 0.05, 'Leave', { fontSize: '34px', fill: '#fff', fontFamily: 'Honk', fontStyle: 'bold', align: 'center' });
